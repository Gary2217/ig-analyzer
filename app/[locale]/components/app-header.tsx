...
export default function AppHeader({ locale }: { locale: string }) {
  ...
  const reconnectLabel = locale === "zh-TW" ? "重新連接 Instagram" : "Reconnect Instagram"
                    ...
                    <div className="hidden sm:block absolute right-0 mt-2 w-[360px] max-w-[92vw] rounded-xl border border-white/10 bg-[#0b1220]/90 backdrop-blur-md shadow-xl overflow-hidden z-[100]">
                      ...
                      <div className="max-h-[60vh] overflow-auto">
                        {igAccountsLoading ? (
                          ...
                          <div className="p-1">
                            <div className="p-2">
                              <Link href={oauthUrl} className="w-full inline-flex items-center justify-center h-10 rounded-lg border border-white/10 bg-white/5 text-sm text-white/85 hover:bg-white/10">
                                {reconnectLabel}
                              </Link>
                            </div>
                            {igPickerHint ? (
                        ...
                        <div className="p-2 overflow-auto" style={{ maxHeight: "calc(82vh - 56px)" }}>
                          {igAccountsLoading ? (
                            ...
                            <div className="space-y-1">
                              <div className="p-1">
                                <Link href={oauthUrl} className="w-full inline-flex items-center justify-center h-11 rounded-xl border border-white/10 bg-white/5 text-sm text-white/85 hover:bg-white/10">
                                  {reconnectLabel}
                                </Link>
                              </div>
                              {igPickerHint ? (
